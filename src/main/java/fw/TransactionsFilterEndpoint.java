...
public class TransactionsFilterEndpoint {
	...
	public CollectionResponse<TransactionsFilter> listTransactionsFilter(@Nullable @Named("cursor") String cursorString,
		...
		return CollectionResponse.<TransactionsFilter> builder().setItems(execute).setNextPageToken(cursorString)
				.build();
	}
	...
	public TransactionsFilter updateTransactionsFilter(TransactionsFilter transactionsfilter) {
		...
		try {
			...
			transactionsfilter.setId(KeyFactory.createKey(TransactionsFilter.class.getSimpleName(), transactionsfilter.getId().getId()));
	...
	private boolean containsTransactionsFilter(TransactionsFilter transactionsfilter) {
		...
		try {
			mgr.getObjectById(TransactionsFilter.class, transactionsfilter.getId().getId());
